...
public:
	...
	static const FOP heighest(std::vector<FOP> &objects);
	static const OAL heighest(std::vector<OAL> &objects);
	const boost::shared_ptr<SpatialObject> heighest(std::list<boost::shared_ptr<SpatialObject> > &objects);
	static const OAL lowest(std::vector<OAL> &objects);
	const boost::shared_ptr<SpatialObject>lowest(std::list<boost::shared_ptr<SpatialObject> > &objects);
	static const FOP lowest(std::vector<FOP> &objects);
	const bool lowest(std::list<FOP> &objects);
	static const FOP heighest(std::list<FOP> &objects);
	const bool isHeighest(std::list<FOP> &objects);
	...
	const boost::shared_ptr<SpatialObject> mostRearward(std::list<boost::shared_ptr<SpatialObject> > &objects);
	static const FOP mostForward(std::list<FOP> &objects);
	static const FOP mostForward(std::vector<FOP> &objects);
	static const OAL mostForward(std::vector<OAL> &objects);
	const boost::shared_ptr<SpatialObject> mostForward(std::list<boost::shared_ptr<SpatialObject> > &objects);
