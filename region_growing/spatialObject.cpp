...
const FOP SpatialObject::heighest(std::vector<FOP> &objects){
...
const FOP SpatialObject::heighest(std::list<FOP> &objects){
...
const OAL SpatialObject::heighest(std::vector<OAL> &objects){
...
const boost::shared_ptr<SpatialObject> SpatialObject::heighest(std::list<boost::shared_ptr<SpatialObject> > &objects){
...
const OAL SpatialObject::lowest(std::vector<OAL> &objects){
	std::vector<OAL>::iterator it;
	OAL candidate = *objects.begin();
	for(it=objects.begin(); it!=objects.end(); it++){
...
const bool SpatialObject::isHeighest(std::list<FOP> &objects){
	std::list<FOP>::iterator it;
	for(it=objects.begin(); it!=objects.end(); it++){
		if(this != (*it).obj.get()){
...
const bool SpatialObject::lowest(std::list<FOP> &objects){
	std::list<FOP>::iterator it;
	for(it=objects.begin(); it!=objects.end(); it++){
		if(this != (*it).obj.get()){
...
const FOP SpatialObject::lowest(std::vector<FOP> &objects){
	std::vector<FOP>::iterator it;
	FOP candidate = *objects.begin();
	for(it=objects.begin(); it!=objects.end(); it++){
		if((*it).obj->below(*candidate.obj.get())){
...
const boost::shared_ptr<SpatialObject> SpatialObject::lowest(std::list<boost::shared_ptr<SpatialObject> > &objects){
	std::list<boost::shared_ptr<SpatialObject> > ::iterator it;
	boost::shared_ptr<SpatialObject> candidate = *objects.begin();
	for(it=objects.begin(); it!=objects.end(); it++){
...
const boost::shared_ptr<SpatialObject> SpatialObject::mostRearward(std::list<boost::shared_ptr<SpatialObject> > &objects){
	std::list<boost::shared_ptr<SpatialObject> > ::iterator it;
	boost::shared_ptr<SpatialObject> candidate = *objects.begin();
	for(it=objects.begin(); it!=objects.end(); it++){
...
const boost::shared_ptr<SpatialObject> SpatialObject::mostForward(std::list<boost::shared_ptr<SpatialObject> > &objects){
	std::list<boost::shared_ptr<SpatialObject> > ::iterator it;
	boost::shared_ptr<SpatialObject> candidate = *objects.begin();
	for(it=objects.begin(); it!=objects.end(); it++){
		if(candidate->centerOfMass[0]<((*it)->getCoG()[0])){
...
const FOP SpatialObject::mostForward(std::vector<FOP> &objects){
	std::vector<FOP>::iterator it;
	FOP candidate = *objects.begin();
	for(it=objects.begin(); it!=objects.end(); it++){
...
const FOP SpatialObject::mostForward(std::list<FOP> &objects){
	std::list<FOP>::iterator it;
	FOP candidate = *objects.begin();
	for(it=objects.begin(); it!=objects.end(); it++){
		if(candidate.obj->centerOfMass[0]<((*it).obj->getCoG()[0])){
...
const OAL SpatialObject::mostForward(std::vector<OAL> &objects){
	std::vector<OAL>::iterator it;
	OAL candidate = *objects.begin();
	for(it=objects.begin(); it!=objects.end(); it++){
		if(candidate.obj->centerOfMass[0]<((*it).obj->getCoG()[0])){
